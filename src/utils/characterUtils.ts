...
function isSkill(object: any): object is ISkill {
  return (
    ...
    (typeof object.icon === "undefined" ||
      typeof object.icon === "string" ||
      typeof object.icon !== null) &&
    (typeof object.video === "undefined" ||
      typeof object.video === "string" ||
      typeof object.video !== null)
  );
}
...
function parseSkills(skills: any, characterName: any): ISkill[] {
...
export const toNewCharacter = (object: any): NewCharacterEntry => {
  let newCharacter: NewCharacterEntry = {
    ...
    skills: parseSkills(object.skills, object.name),
